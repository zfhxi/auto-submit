...
if __name__=='__main__':
    imgUrl='http://authserver.cqu.edu.cn/authserver/captcha.html?ts=784'
    import requests
    res=requests.session()
    print(Utils.getCodeFromImg(res,imgUrl))